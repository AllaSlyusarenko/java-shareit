...
//    Booking findFirstByBookerAndEndIsBeforeOrderByStartDesc(User user, LocalDateTime now);
//    Booking findFirstByBookerAndStartIsAfterOrderByStart(User user, LocalDateTime now);
